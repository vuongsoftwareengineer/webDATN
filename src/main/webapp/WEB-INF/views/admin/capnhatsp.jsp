...
<h2 style="margin-left: 250px; font-style: italic;"> Xin chào ${sessionScope.admin.getHoTen()}! </h2>
  <p style="margin-left: 250px">Chào mừng bạn quay trở lại với trang quản trị của Website </p>
		...
		<div class="container">
		<h2 class="lb">Cập nhật sản phẩm</h2>
		<form:form action="admin/capnhatsp/${sanpham.id}.html" method="post" modelAttribute="sanpham">
			...
			<div class="form-group">
			<br>
				<button class="btn" style="width: 50%">Cập nhật sản phẩm</button>
	</div>
	</form:form>
	</div>
	</div>
