...
<h2 style="font-weight: bold;color: #FF6666">CHI TIẾT ĐẶT HÀNG</h2>
			<form:form action="admin/chitiet_dat/${chitiet.id}.html" method="post" modelAttribute="chitiet" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label style="font-weight: bold;color: #FF6666" class="lb">Mã chi tiết đặt hàng</label>
				<br>
				...
				<br>
				<label class="frm1" style="color: black"><b>${chitiet.idHH}</b>-${p.ten}</label>
				
			</div>
			<div class="form-group">
				<label style="font-weight: bold;color: #FF6666" class="lb">Số lượng Đặt</label>
				<br>
			...
			<div class="form-group">
				...
				<br>
			<label class="frm1" style="color: black"><f:formatNumber minFractionDigits="0" value="${p.gia*chitiet.soLuong}" type="number"/>đ</label>
			</div>
			<div class="form-group">
				<label style="font-weight: bold;color: #FF6666" class="lb">Mã phiếu đặt hàng</label>
				<br>
				<form:input class="frm1" readonly="true" path="idPhieuDatHang" />
			</div>
			</div>
			<div class="col-sm-6" style="background-color: white;">
