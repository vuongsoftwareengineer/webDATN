...
<h2 style="margin-left: 250px; font-style: italic; color: #8B4513"> Xin chào ${sessionScope.admin.getHoTen()}! </h2>
  <p style="margin-left: 250px; color: brown">Chào mừng bạn quay trở lại với trang quản trị của Website </p>
    ...
    <tbody>
    <c:forEach var="p" items="${thongkeloinhuanquys}">
      <tr>
        <td>${p.id}</td>
                                ...
                                <div class="col-md-6 chit-chat-layer1-rit" style="margin-left: 600px">    	
                                    <div class="glocy-chart">
                                        <div class="span-2c">  
                                            ...
                                            <script>
                                                var barChartData = {
                                                    labels: [<c:forEach var="item" items="${thongkeloinhuanquys}">'${item.id}',</c:forEach>],
                                                    datasets: [
                                                        {
                                                            fillColor: "#FC8213",
                                                            data: [<c:forEach var="item" items="${thongkeloinhuanquys}">${item.loinhuan},</c:forEach>]
                                                        }
                                                    ]
