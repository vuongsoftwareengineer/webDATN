...
<h2 style="margin-left: 250px; font-style: italic;"> Xin chào ${sessionScope.admin.getHoTen()}! </h2>
  <p style="margin-left: 250px">Chào mừng bạn quay trở lại với trang quản trị của Website </p>
		...
		<div class="container">
		<h2 class="lb">Cập nhật thể loại</h2>
		<form:form action="admin/capnhattl/${theloai.id}.html" method="post" modelAttribute="theloai">
			<div class="form-group">
				<label class="lb">Mã thể loại</label>
				<br>
				<form:input readonly="true" class="frm" path="id" />
				
				</div>
				<div class="form-group">
				<label class="lb">Tên thể loại</label>
				<br>
			...
			<div class="form-group">
			<br>
				<button class="btn" style="width: 50%">Cập nhật thể loại</button>
	</div>
	</form:form>
	</div>
	</div>
